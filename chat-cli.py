    ...
    def sendstring(self,string):
        try:
            ...
            while True:
                ...
                if (data):
                    receivemsg = "{}{}" . format(receivemsg,data.decode('utf-8'))  #data harus didecode agar dapat di operasikan dalam bentuk string
                    if receivemsg[-4:]=='\r\n\r\n':
